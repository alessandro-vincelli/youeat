 ...
 * 
 */
public class CommentsSearchPanel extends Panel {
...
//                    for (Comment comment : commentService.find(input, 0, 100, Comment.CREATIONTIME_FIELD, true)(input)) {
//                        choises.add(comment.getName() + " <i>(" + risto.getCity() + ")</i>" );
//                    }
//                }
//            } catch (YoueatException e) {
//            }
