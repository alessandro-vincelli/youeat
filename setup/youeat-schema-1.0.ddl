    ...
    create table ristorante_activities (
        ristorante varchar(36) not null,
        activities varchar(36) not null,
        unique (activities)
    );
    ...
    alter table activity_ristorante 
        add constraint FK93343C9AA76A44B 
    ...
    alter table eater_activities 
        add constraint FKA4F5EE677A69A455 
        foreign key (activities) 
        references activity;

    alter table eater_activities 
        add constraint eater_to_activities_fk 
        foreign key (eater) 
        references eater;
    ...
    alter table ristorante_activities 
        add constraint FK709D5753CC602F0E 
        foreign key (activities) 
        references activity_ristorante;

    alter table ristorante_activities 
        add constraint FK709D5753AA76A44B 
        foreign key (ristorante) 
        references ristorante;
