...
import it.av.youeat.service.JcrRistoranteService;
...
public class JcrRistoranteServiceJackrabbit extends JcrApplicationServiceJackrabbit<Ristorante> implements JcrRistoranteService {
     ...
     * (non-Javadoc)
     * 
     * @see it.av.youeat.service.JcrRistoranteService#commit(it.av.youeat.ocm.model.Ristorante)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see it.av.youeat.service.JcrRistoranteService#getAllRevisionsById(long)
     */
    @Override
