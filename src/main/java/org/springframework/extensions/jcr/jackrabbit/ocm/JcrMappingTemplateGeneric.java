 ...
 * 
 */
public class JcrMappingTemplateGeneric<T> extends JcrTemplate implements JcrMappingOperationsGeneric<T> {
     ...
     */
    public JcrMappingTemplateGeneric() {
        super();
     ...
     */
    public JcrMappingTemplateGeneric(SessionFactory sessionFactory, Mapper mapper) {
    ...
    public T getObject(final java.lang.String path) {
        return (T)execute(new JcrMappingCallback() {
            public T doInJcrMapping(ObjectContentManager manager) throws JcrMappingException {
                return (T)manager.getObject(path);
            }
        }, true);
    }
    ...
    public T getObject(final Query query) {
        return (T)execute(new JcrMappingCallback() {
            public T doInJcrMapping(ObjectContentManager manager) throws JcrMappingException {
                return (T)manager.getObject(query);
            }
        }, true);
    }
    
    public Collection<T> getObjects(final Query query) {
        return (Collection<T>) execute(new JcrMappingCallback() {
            public Collection<T> doInJcrMapping(ObjectContentManager manager) throws JcrMappingException {
    ...
    public VersionIterator getAllRevisions(final String path) {
        return (VersionIterator) execute(new JcrMappingCallback() {
            public VersionIterator doInJcrMapping(ObjectContentManager manager) throws JcrMappingException {
                VersionIterator versionIterator = null;
                if (StringUtils.isNotEmpty(path)) {
                    try {
                        versionIterator = manager.getAllVersions(path);
    ...
    public void checkin(final String path) {
        execute(new JcrMappingCallback() {
            public Object doInJcrMapping(ObjectContentManager manager) throws JcrMappingException {
                try {
    ...
    public String getBaseVersion(final String path) {
        return (String)execute(new JcrMappingCallback() {
            public String doInJcrMapping(ObjectContentManager manager) throws JcrMappingException {
                try {
                    return (String)manager.getBaseVersion(path).getName();
                } catch (VersionException e) {
                    throw new JcrMappingException(e);
                }
            }
    ...
    public T getObjectByVersion(final String path, final String versionNumber) {
        return (T)execute(new JcrMappingCallback() {
            public T doInJcrMapping(ObjectContentManager manager) throws JcrMappingException {
                return (T)manager.getObject(path, versionNumber);
            }
        }, true);
    }    
}
